...
const EditFinance = () => {
    ...
    const { id } = useParams(); // Récupérer l'ID du financement depuis les paramètres d'URL
    ...
    const { responseAxios, error, loading, fetchData } = useAxios({ url: `${urlFinancements}/${id}`, method: 'PATCH' });
