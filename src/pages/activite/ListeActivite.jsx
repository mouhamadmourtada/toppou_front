...
const ListeActivite = () => {
    ...
    const gotoEditActivity = (id) => {
        navigate(`/app/admin/activity/edit/${id}`);
    };

    const gotoViewActivity = (id) => {
        navigate(`/app/admin/activity/show/${id}`);
    }
                            ...
                            <tbody className='text-tertiaire'>
                                {activities.map((activity, rowIndex) => (
                                    <tr key={rowIndex}>
                                        ...
                                        <td className="px-3 py-3 border-b">{formatDate(activity.dateDebutActivite)}</td>
                                        <td className="px-3 py-3 border-b">{formatDate(activity.dateFinEffective)}</td>
                                        ...
                                        <td className='border-b flex justify-center items-center h-full text-sm px-3 py-3 border-l'>
                                            <div className="px-4 border-2 border-gray-200 flex justify-center rounded items-center space-x-2 text-sm max-w-20 shadow-xl p-0.5 bg-gray-100">
                                                <div className="text-secondaire cursor-pointer" onClick={() => gotoViewActivity(activity.id)}>
                                                ...
                                                <div className="text-secondaire cursor-pointer" onClick={() => gotoEditActivity(activity.id)}>
